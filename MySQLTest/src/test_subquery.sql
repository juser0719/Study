...
show tables;
=======
>>>>>>> 7abd42d7c37495924ae2cd962ae002d75da78699
-- [하위질의(SubQuery)]
...
select city
from locations
where location_id = (select location_id from departments where dapartment_id = 
	(select department_id from employees where first_name = 'Alexander' and last_name = 'Huold'));
...
where job_id = (
		select job_id
		from employees
		where lower(first_name) = 'oliver') and ifnull(department_id,0) != (
