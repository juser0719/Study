		...
		<div class="signup-form">
			<form action="${root }/main" method="post" class="form-horizontal">
				...
				<div class="form-group row">
					...
					<div class="col-8">
						<input type="text" class="form-control" value ="${userinfo.userId }" name="id" readonly>					
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-4">비밀번호</label>
					<div class="col-8">
						<input type="password" class="form-control" value ="${userinfo.userPwd }" name="password" required="required">					
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-4">이름</label>
					<div class="col-8">
						<input type="text" class="form-control" value ="${userinfo.userName }" name="name" required="required">					
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-4">주소</label>
					<div class="col-8">
						<input type="text" class="form-control" value ="${userinfo.email }" name="address" required="required">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-4">전화번호</label>
					<div class="col-8">
						<input type="tel" class="form-control" value ="${userinfo.tel }" name="tel" required="required">
					</div>
				</div>
