...
<body>
	...
	<section id="hero" style='background-image: none'>
		<div class="signup-form">
			<form action="${root }/user/register" method="post" class="form-horizontal">
				...
				<div class="form-group row">
					...
					<div class="col-8">
						<input type="password" class="form-control" name="userPwd"
							placeholder="영문 숫자 포함 5자리 이상" minlength="5" required="required">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-8">
						<input type="tel" class="form-control" name="tel"
							placeholder="010-****-****" required="required">
					</div>
				</div>

				<div class="form-group row">
					<div class="col-8 offset-4">
						<button type="submit" class="btn btn-primary btn-lg">등록
							&nbsp; &#10003;</button>
					</div>
				</div>
			</form>
