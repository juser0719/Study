...
public class NoticeController {
	...
	@PostMapping
	public ResponseEntity<String> writeNotice(@RequestBody @ApiParam(value = "게시글 정보.", required = true) NoticeDto noticeDto)
			throws Exception {
	...
	public ResponseEntity<List<NoticeDto>> listNotice(
			@ApiParam(value = "게시글을 얻기위한 부가정보.", required = true) NoticeParameterDto noticeParameterDto) throws Exception {
	...
	@PutMapping
	public ResponseEntity<String> modifyNotice(@RequestBody @ApiParam(value = "수정할 글정보.", required = true) NoticeDto noticeDto)
			throws Exception {
	...
	public ResponseEntity<String> deleteNotice(
			@PathVariable("noticeno") @ApiParam(value = "살제할 글의 글번호.", required = true) int noticeno) throws Exception {
