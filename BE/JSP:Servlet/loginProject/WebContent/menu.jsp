...
<body>
<div id="menu">
<a href="/log/index.jsp">HOME</a>
<%
	String userid=(String)session.getAttribute("logOK");
	if(userid==null){
%>
		<a href="/log/login/login.jsp">로그인 화면</a>
<%		
	}else{
%>
		<a href="/log/book/bookInsert.jsp">도서등록</a>
		<a href="/log/listBook">도서목록</a>
		<a href="/log/logout">로그아웃</a>
		<span id="login_info"><b><%=userid%></b>님이 로그인 하셨습니다</span> 
<%		
	}
%>
</div>
