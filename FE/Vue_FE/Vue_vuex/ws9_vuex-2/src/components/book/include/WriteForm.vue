  ...
  <b-container class="bv-example-row mt-3">
    ...
    <b-row class="mb-1">
      <b-col class="text-left">
        <b-form>
          <b-form-group id="isbn-group" label="도서번호(ISBN):" label-for="isbn" description="ISBN을 입력하세요.">
            <b-form-input
              v-if="type == 'create'"
              id="isbn"
              ref="isbn"
          ...
          <b-form-group id="title-group" label="도서제목:" label-for="title" description="도서제목을 입력하세요.">
            <b-form-input id="title" ref="title" v-model="title" type="text" required placeholder="도서제목 입력..." />
          </b-form-group>
          <b-form-group id="author-group" label="저자:" label-for="author" description="저자를 입력하세요.">
            <b-form-input id="author" ref="author" v-model="author" type="text" required placeholder="저자 입력..." />
          </b-form-group>
          <b-form-group id="price-group" label="가격:" label-for="price" description="가격을 입력하세요.">
            <b-form-input id="price" ref="price" v-model="price" type="text" required placeholder="가격 입력..." />
          </b-form-group>

          <b-form-group id="content-group" label="도서내용:" label-for="content" ref="content">
            <b-form-textarea
              id="content"
              v-model="content"
              placeholder="도서내용 입력..."
          ...
          <b-button v-if="type == 'create'" variant="primary" class="m-1" @click="checkValue">도서등록</b-button>
          <b-button v-else variant="success" class="m-1" @click="checkValue">도서수정</b-button>
          <b-button variant="primary" class="m-1" @click="moveList">목록</b-button>
        </b-form>
      </b-col>
    </b-row>
  </b-container>
