  ...
  <b-container class="bv-example-row mt-3">
    ...
    <b-row class="mb-1">
      <b-col class="text-left">
        <b-button variant="outline-primary" class="w-30" @click="listBook">목록</b-button>
      </b-col>
      <b-col class="text-right">
        <b-button variant="outline-info" size="sm" class="w-30 mr-2" @click="moveModifyBook">글수정</b-button>
        <b-button variant="outline-danger" size="sm" class="w-30" @click="deleteBook">글삭제</b-button>
      </b-col>
    </b-row>
    <!-- 도서정보 상세보기 Component -->
